// Locked design tokens for the Owner Branch Leaderboard.
// Mirrors the original EdullentOwnerDashboard.jsx — do not change values.

export const FONT = "'Montserrat', -apple-system, BlinkMacSystemFont, sans-serif";

export const T = {
  pageBg: "#EEF4FF", cardBg: "#FFFFFF",
  B1: "#0055FF", B2: "#1166FF",
  T1: "#001040", T3: "#5070B0", T4: "#99AACC",
  GREEN: "#34C759", GREEN_TEXT: "#00833A",
